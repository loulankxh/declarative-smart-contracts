contract BrickBlockToken {
  ...
  function updateAllowedOnDeleteAllowanceTotal_r26(address f,address s,uint n) private    {
      uint d = decreaseTotal[f][s].m;
      uint l = spentTotal[f][s].m;
      uint m = (n-l)-d;
      if(m==allowed[f][s].a) {
        allowed[f][s] = AllowedTuple(0,false);
      }
  }
  function updateAllowedOnDeleteDecreaseTotal_r26(address f,address s,uint d) private    {
      uint l = spentTotal[f][s].m;
  ...
  function updateBalancesOnIncrementTotalIn_r21(address p,int i) private    {
      ...
      updateBalancesOnInsertTotalIn_r21(p,newValue);
  }
  function updateOnceEndSaleOnInsertFinalizeTokenSale_r46() private    {
      onceEndSale = OnceEndSaleTuple(true,true);
  }
  function updateAllowedOnDeleteSpentTotal_r26(address f,address s,uint l) private    {
      uint d = decreaseTotal[f][s].m;
      uint n = allowanceTotal[f][s].m;
      uint m = (n-l)-d;
      if(m==allowed[f][s].a) {
  ...
  function updateBalancesOnInsertTotalIn_r21(address p,uint i) private    {
      TotalInTuple memory toDelete = totalIn[p];
      if(toDelete._valid==true) {
        updateBalancesOnDeleteTotalIn_r21(p,toDelete.n);
      }
      uint o = totalOut[p].n;
      uint s = i-o;
      balances[p] = BalancesTuple(s,true);
  }
  ...
  function updateTotalOutOnInsertTransfer_r14(address p,uint n) private    {
      int delta2 = int(n);
      updateBalancesOnIncrementTotalOut_r21(p,delta2);
      totalOut[p].n += n;
  }
  function updateAllowedOnInsertAllowanceTotal_r26(address f,address s,uint n) private    {
      AllowanceTotalTuple memory toDelete = allowanceTotal[f][s];
      if(toDelete._valid==true) {
        updateAllowedOnDeleteAllowanceTotal_r26(f,s,toDelete.m);
      }
      uint d = decreaseTotal[f][s].m;
      uint l = spentTotal[f][s].m;
      uint m = (n-l)-d;
      allowed[f][s] = AllowedTuple(m,true);
  }
  function updateBalancesOnDeleteTotalIn_r21(address p,uint i) private    {
      uint o = totalOut[p].n;
      uint s = i-o;
      if(s==balances[p].a) {
        balances[p] = BalancesTuple(0,false);
      }
  }
  function updateBalancesOnIncrementTotalOut_r21(address p,int o) private    {
      int _delta = int(o);
      uint newValue = updateuintByint(totalOut[p].n,_delta);
      updateBalancesOnInsertTotalOut_r21(p,newValue);
  }
  function updateAllowedOnIncrementAllowanceTotal_r26(address f,address s,int n) private    {
      int _delta = int(n);
      uint newValue = updateuintByint(allowanceTotal[f][s].m,_delta);
      updateAllowedOnInsertAllowanceTotal_r26(f,s,newValue);
  }
  ...
  function updateBalancesOnDeleteTotalOut_r21(address p,uint o) private    {
      uint i = totalIn[p].n;
      uint s = i-o;
      if(s==balances[p].a) {
        balances[p] = BalancesTuple(0,false);
  ...
  function updateDecreaseTotalOnInsertDecreaseAllowance_r29(address f,address s,uint n) private    {
      int delta2 = int(n);
      updateAllowedOnIncrementDecreaseTotal_r26(f,s,delta2);
  ...
  function updateBalancesOnInsertTotalOut_r21(address p,uint o) private    {
      TotalOutTuple memory toDelete = totalOut[p];
      if(toDelete._valid==true) {
        updateBalancesOnDeleteTotalOut_r21(p,toDelete.n);
      }
      uint i = totalIn[p].n;
      uint s = i-o;
      balances[p] = BalancesTuple(s,true);
  ...
  function updateAllowedOnIncrementSpentTotal_r26(address f,address s,int l) private    {
      int _delta = int(l);
      uint newValue = updateuintByint(spentTotal[f][s].m,_delta);
      updateAllowedOnInsertSpentTotal_r26(f,s,newValue);
  }
  function updateAllowedOnIncrementDecreaseTotal_r26(address f,address s,int d) private    {
      int _delta = int(d);
      uint newValue = updateuintByint(decreaseTotal[f][s].m,_delta);
      updateAllowedOnInsertDecreaseTotal_r26(f,s,newValue);
  }
  ...
  function updateSpentTotalOnInsertTransferFrom_r5(address f,address s,uint n) private    {
      int delta1 = int(n);
      updateAllowedOnIncrementSpentTotal_r26(f,s,delta1);
      spentTotal[f][s].m += n;
  }
  ...
  function updateAllowedOnInsertSpentTotal_r26(address f,address s,uint l) private    {
      SpentTotalTuple memory toDelete = spentTotal[f][s];
      if(toDelete._valid==true) {
        updateAllowedOnDeleteSpentTotal_r26(f,s,toDelete.m);
      }
      uint d = decreaseTotal[f][s].m;
      uint n = allowanceTotal[f][s].m;
      uint m = (n-l)-d;
  ...
  function updateAllowedOnInsertDecreaseTotal_r26(address f,address s,uint d) private    {
      DecreaseTotalTuple memory toDelete = decreaseTotal[f][s];
      if(toDelete._valid==true) {
        updateAllowedOnDeleteDecreaseTotal_r26(f,s,toDelete.m);
      }
      uint l = spentTotal[f][s].m;
      uint n = allowanceTotal[f][s].m;
      uint m = (n-l)-d;
