// source: https://etherscan.io/address/0x0d8775f648430679a709e98d2b0cb6250d2887ef#code

// Upgraded from pragma solidity ^0.4.10 to ^0.8.12
...
// contract BAToken is StandardToken, SafeMath {  // renamed to Bat to match compiled contract name for testing
contract Bat is StandardToken, SafeMath {
    ...
    function finalize() external {
      ...
      // move to operational
      isFinalized = true;
      require(payable(ethFundDeposit).send(address(this).balance));  // send the eth to Brave International
    }
    ...
    function refund() external {
      ...
      require(msg.sender != batFundDeposit);    // Brave Intl not entitled to a refund
